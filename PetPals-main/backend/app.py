...
app.config["JWT_SUBJECT_CLAIM"] = None  # Disable subject requirement
app.config["JWT_IDENTITY_CLAIM"] = "identity"  # Standardize identity claim
...
def add_pet_listing():
    ...
    try:
        ...
        # Clean up the saved image if DB operation fails
